...
home_players = [split_name(name) for name in home_players_raw]
away_players = [split_name(name) for name in away_players_raw]

if len(home_players) == 3 and len(away_players) == 3:
    ...
    st.warning("Please select 3 players for each team to run predictions.")
