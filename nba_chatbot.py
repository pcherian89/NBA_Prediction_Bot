...
<div style="display: flex; align-items: center;">
    <img src="https://raw.githubusercontent.com/pcherian89/NBA_Prediction_Bot/main/nba_logo.png" width="70" style="margin-right: 15px;" />
    <h1 style="margin: 0; font-size: 42px;">AI-Powered NBA Game Analyzer</h1>
</div>
...
if (
    ...
    if st.button("🔮 Run Prediction"):
        ...
        odds_df = pd.DataFrame({
            "Team": [f'{result["home_team"]} (Home)', f'{result["away_team"]} (Away)'],
            "Win %": [f'{result["home_final_probability"]:.0%}', f'{result["away_final_probability"]:.0%}'],
            "Decimal Odds": [home_decimal, away_decimal],
            "Odds": [home_american, away_american]
        })
